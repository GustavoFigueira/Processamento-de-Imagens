...
namespace Processamento_de_Imagens.Code
{
    ...
    public static class Algorithms
    {
        ...
        // Dilatação
        public static Bitmap Dilatacao(this Bitmap sourceBitmap, int matrixSize, bool applyBlue = true, bool applyGreen = true, bool applyRed = true)
        {
            var sourceData = sourceBitmap.LockBits(new Rectangle(0, 0, sourceBitmap.Width, sourceBitmap.Height), ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
        ...
        // Erosão
        public static Bitmap Erosao(this Bitmap sourceBitmap, int matrixSize, bool applyBlue = true, bool applyGreen = true, bool applyRed = true)
        {
            var sourceData = sourceBitmap.LockBits(new Rectangle(0, 0, sourceBitmap.Width, sourceBitmap.Height), ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
        ...
        // Abertura
        public static Bitmap Abertura(this Bitmap sourceBitmap, int matrixSize, bool applyBlue = true, bool applyGreen = true, bool applyRed = true)
        {
            var resultBitmap = sourceBitmap.Erosao(matrixSize, applyBlue, applyGreen, applyRed);

            resultBitmap = resultBitmap.Dilatacao(matrixSize, applyBlue, applyGreen, applyRed);

            return resultBitmap;
        }

        // Fechamento
        public static Bitmap Fechamento(this Bitmap sourceBitmap, int matrixSize, bool applyBlue = true, bool applyGreen = true, bool applyRed = true)
        {
            var resultBitmap = sourceBitmap.Dilatacao(matrixSize, applyBlue, applyGreen, applyRed);

            resultBitmap = resultBitmap.Erosao(matrixSize, applyBlue, applyGreen, applyRed);
